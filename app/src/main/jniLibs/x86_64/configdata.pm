...
our %config = (
  AR => "llvm-ar",
  ARFLAGS => [ "rs" ],
  CC => "/home/weare/Android/Sdk/ndk/21.4.7075529//toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android21-clang",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/home/weare/Android/Sdk/ndk/21.4.7075529//toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android21-clang",
  minor => "1.1",
  ...
  perl_version => "5.32.1",
  perlargv => [ "no-comp", "no-dtls", "no-ec2m", "no-psk", "no-srp", "no-ssl2", "no-ssl3", "no-camellia", "no-idea", "no-md2", "no-md4", "no-mdc2", "no-rc2", "no-rc4", "no-rc5", "no-rmd160", "no-whirlpool", "no-dso", "no-hw", "no-ui-console", "no-shared", "no-unit-test", "android-x86_64", "-D__ANDROID_API__=21", "--prefix=/", "--openssldir=/" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => "/home/weare/Android/Sdk/ndk/21.4.7075529//toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android21-clang",
